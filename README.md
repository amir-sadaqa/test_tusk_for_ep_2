...
5. Далее обращаемся непосредственно к модели в файле "loss_settlement_model.xlsx"
...
P.S. Файл "loss_settlement_model.xlsx" позволяет вносить изменения только в незащищенные ячейки, т.е. ячейки с теми данными, с которыми можно "играть". Остальные ячейки - с формулами - защищены и производят расчет автоматически на основании изменяемых показателей модели.
___
